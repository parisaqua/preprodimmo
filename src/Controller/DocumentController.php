...
{
    /**
     * @Route("/", name="document.manager.index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="document.manager.new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}", name="document.manager.show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="document.manager.edit", methods={"GET","POST"})
     */

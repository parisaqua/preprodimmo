 ...
 */
final class Version20200412144620 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lease ADD charge DOUBLE PRECISION DEFAULT \'NULL\', DROP charges, CHANGE signature_date signature_date DATETIME DEFAULT \'NULL\', CHANGE effect_date effect_date DATETIME DEFAULT \'NULL\', CHANGE length length VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE rent rent DOUBLE PRECISION DEFAULT \'NULL\', CHANGE vat vat DOUBLE PRECISION DEFAULT \'NULL\', CHANGE payment_term payment_term INT DEFAULT NULL');

 ...
 */
final class Version20200427053858 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property CHANGE price price INT NOT NULL, CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\', CHANGE landing landing VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');

 ...
 */
final class Version20200505093750 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE roles roles JSON NOT NULL, CHANGE password_requested_at password_requested_at DATETIME DEFAULT NULL, CHANGE token token VARCHAR(255) DEFAULT NULL, CHANGE user_registrated_at user_registrated_at DATETIME DEFAULT NULL, CHANGE creator creator INT DEFAULT NULL');

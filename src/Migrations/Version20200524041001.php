 ...
 */
final class Version20200524041001 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE profile ADD telephoneM VARCHAR(35) DEFAULT NULL, ADD telephone_h VARCHAR(35) DEFAULT NULL, ADD telephone_o VARCHAR(35) DEFAULT NULL, DROP telephone, CHANGE user_id user_id INT DEFAULT NULL, CHANGE image_name image_name VARCHAR(255) DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE city city VARCHAR(255) DEFAULT NULL, CHANGE address address VARCHAR(255) DEFAULT NULL, CHANGE postal_code postal_code VARCHAR(255) DEFAULT NULL, CHANGE creator creator INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE address CHANGE second_line second_line VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE address CHANGE second_line second_line VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');

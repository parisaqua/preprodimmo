 ...
 */
final class Version20200427051857 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property ADD landing VARCHAR(255) DEFAULT NULL, ADD access VARCHAR(255) DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property DROP landing, DROP access, CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
